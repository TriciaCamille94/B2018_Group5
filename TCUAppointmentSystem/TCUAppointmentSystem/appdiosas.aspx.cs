...
{
    public partial class appdiosas : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("appdiosas.aspx");
        }
        ...
        void LoadRecord()
        {
            ...
            SqlCommand comm = new SqlCommand("select * from tbl_appointment where dept='Osas'", con);
