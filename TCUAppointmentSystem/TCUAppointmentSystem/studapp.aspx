<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studapp.aspx.cs" Inherits="TCUAppointmentSystem.studapp" %>
        ...
        <br />
          <br />
                            ...
                            <asp:Panel ID="Panel4" runat="server" CssClass="auto-style2" Font-Bold="True" Font-Size="X-Large" ForeColor="Black" Height="733px" >
                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="60px" style="margin-left:350px" ForeColor="White" Text="List of Appointment"></asp:Label>
                                <br />
                                <br />
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="Medium" Height="14%" style="margin-left:10px" Width="894px">
                                 ...
                                 <asp:Label ID="Label3" runat="server" style="margin-left:10px" Text="Dispprove" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                <br />
