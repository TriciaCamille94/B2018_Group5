...
{
    public partial class managestaffs : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            ...
            SqlCommand comm = new SqlCommand("select * from tbl_staffs", con);
        ...
        {
            con.Open();
            SqlCommand comm = new SqlCommand("select * from tbl_staffs where sid = '" + int.Parse(TextBox7.Text) + "'", con);
