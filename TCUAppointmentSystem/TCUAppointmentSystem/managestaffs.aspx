<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="managestaffs.aspx.cs" Inherits="TCUAppointmentSystem.managestaffs" %>
        ...
        <br />
          <br />
                            ...
                            <asp:Panel ID="Panel4" runat="server" CssClass="auto-style2" Font-Bold="True" Font-Size="X-Large" ForeColor="Black" Height="411px" >
                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="40px" style="margin-left:450px" ForeColor="White" Text="Manage Staff"></asp:Label>
                                <br />
                                <br />
                               <asp:Label ID="Label7" runat="server"  style="margin-left:80px" Text="Staff ID:" Font-Size="Large" ForeColor="White"></asp:Label>
                                <asp:TextBox ID="TextBox7" runat="server" style="margin-left:60px" Width="328px" Font-Size="Large"></asp:TextBox>

                                
                                <asp:Label ID="Label3" runat="server"  style="margin-left:80px" Text="Name:" Font-Size="Large" ForeColor="White"></asp:Label>
                                <asp:TextBox ID="TextBox1" runat="server" style="margin-left:73px" Width="328px" Font-Size="Large"></asp:TextBox>
                                ...
                                <asp:Label ID="Label8" runat="server"  style="margin-left:210px" Text="Department:" Font-Size="Large" ForeColor="White"></asp:Label>
                                <asp:DropDownList ID="DropDownList2" runat="server" Height="25px" Width="328px" style="margin-left:20px"  Font-Size="Medium" >
                                ...
                                <asp:Label ID="Label4" runat="server" style="margin-left:80px" Text="Position:" Font-Size="Large" ForeColor="White"></asp:Label>
                                <asp:TextBox ID="TextBox2" runat="server" style="margin-left:65px" Width="328px" Font-Size="Large"></asp:TextBox>
                                <asp:Label ID="Label1" runat="server" style="margin-left:80px" Text="Email:" Font-Size="Large" ForeColor="White"></asp:Label>
                                <asp:TextBox ID="TextBox4" runat="server" style="margin-left:65px" Width="328px" Font-Size="Large"></asp:TextBox>
                        ...
                        <asp:Button ID="Button9" runat="server" Text="SEARCH"  BackColor="Red"  style="margin-left:5px" Height="39px" Width="139px" ForeColor="White"  BorderColor="White" OnClick="Button9_Click" />                 
                           ...
                           <br />
                                ...
                                <asp:GridView ID="GridView1" runat="server" style="margin-left:50px" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Height="4%" Width="80%" Font-Size="Medium" >
                                    <Columns>
                                        <asp:BoundField HeaderText="Saff ID:" DataField="sid" />
