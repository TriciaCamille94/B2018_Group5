<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appdicli.aspx.cs" Inherits="TCUAppointmentSystem.appdicli" %>
        ...
        <br />
          <br />
                            ...
                            <asp:Panel ID="Panel4" runat="server" CssClass="auto-style2" Font-Bold="True" Font-Size="X-Large" ForeColor="Black" Height="733px" >
                             ...
                             <asp:Label ID="Label8" runat="server" Font-Size="Medium" style="margin-left:80px " Text=" Id" Font-Bold="True" ForeColor="White"></asp:Label>
