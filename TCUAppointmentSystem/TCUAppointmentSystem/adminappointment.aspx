<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminappointment.aspx.cs" Inherits="TCUAppointmentSystem.adminappointment" %>
        ...
        <br />
          <br />
                            ...
                            <asp:Panel ID="Panel4" runat="server" CssClass="auto-style2" Font-Bold="True" Font-Size="X-Large" ForeColor="Black" Height="733px" >
                                <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="60px" style="margin-left:450px" ForeColor="White" Text="Appointment"></asp:Label>
                                <br />
                                <br />
                                <asp:Label ID="Label1" runat="server" style="margin-left:10px" Text="Registrar" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                <br />
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="Medium" Height="281px"  style="margin-left:10px" Width="894px">
                                    <Columns>
                                 ...
                                 <br />
                                <asp:Label ID="Label6" runat="server" style="margin-left:10px" Text="Library" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                <br />
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="Medium" Height="281px"  style="margin-left:10px" Width="894px">
                                    <Columns>
                                        <asp:BoundField DataField="Name" HeaderText="Name" />
                                        <asp:BoundField DataField="email" HeaderText="Email" />
                                        <asp:BoundField DataField="phone" HeaderText="Phone Number" />
                                  ...
                                  <br />
                                <asp:Label ID="Label7" runat="server" style="margin-left:10px" Text="OSAS" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                <br />
                                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="Medium" Height="281px"  style="margin-left:10px" Width="894px">
                                    <Columns>
                                        <asp:BoundField DataField="Name" HeaderText="Name" />
                                        <asp:BoundField DataField="email" HeaderText="Email" />
                                        <asp:BoundField DataField="phone" HeaderText="Phone Number" />
                                ...
                                <br />
                                <asp:Label ID="Label4" runat="server" style="margin-left:10px" Text="Clinic" Font-Bold="True" Font-Size="Large" ForeColor="White"></asp:Label>
                                <br />
                                <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Font-Size="Medium" Height="281px"  style="margin-left:10px" Width="894px">
                                    <Columns>
                                        <asp:BoundField DataField="Name" HeaderText="Name" />
                                        <asp:BoundField DataField="email" HeaderText="Email" />
                                        <asp:BoundField DataField="phone" HeaderText="Phone Number" />
